...
|---|---|---|
| `emails.html` | Τα email που φτάνουν στο info@ | ✅ 13 είδη «δικά μας» + Spitogatos + άνθρωποι· ενημερώθηκε 02/08 (leads από πινακίδες, «ΕΦΥΓΕ ΔΙΠΛΟ» δίπλα στο «ΔΕΝ ΣΤΑΛΘΗΚΕ») |
...
συχνότερο σημείο σύγχυσης: οι ειδοποιήσεις «ΝΕΟ LEAD» /
«ΕΝΔΙΑΦΕΡΟΜΕΝΟΣ SPITOGATOS» πάνε **μόνο** στον Μάνο. Στο `info@` φτάνει
το *αρχικό* email του Spitogatos, όχι η δική μας ειδοποίηση. Τα τρία
πελατικά έντυπα (ανάθεση, υπόδειξη, απόδειξη) στέλνουν από 31/07/2026
και δικό τους εσωτερικό email **«ΓΙΑ ΑΡΧΕΙΟ CRM»** στο info@, με το
υπογεγραμμένο PDF και οδηγίες πού αρχειοθετείται· η παλιά κάρτα της
