...
|---|---|---|
| `emails.html` | Τα email που φτάνουν στο info@ | ✅ 11 είδη «δικά μας» + Spitogatos + άνθρωποι· ενημερώθηκε 31/07 (ΝΕΑ ΖΗΤΗΣΗ, ΝΕΑ ΑΝΑΘΕΣΗ, ΕΚΤΙΜΗΣΗ, ενεργό lead-reply) |
| `entypa.html` | Τα Έντυπα στο tablet | ✅ 31/07: τα 7 έντυπα ένα-ένα, πρόχειρα, εκκρεμή (outbox), «Από το CRM», σύνδεση με PIN |
