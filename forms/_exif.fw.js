/* =====================================================================
   ...
   ---------------------------------------------------------------------
   Το χρειάζεται το pinakida.html: όταν ο σύμβουλος ανεβάζει φωτογραφίες που
   ...
   Γι' αυτό το pinakida.html ΔΕΝ στηρίζεται σε αυτό — είναι το bonus, με το
	...
	function read(file) {
		return new Promise(function (resolve) {
			...
			/* Σε HEIC το Exif item μπορεί να κάθεται βαθιά μέσα στο mdat, οπότε
			   διαβάζουμε όλο το αρχείο. Μία φωτογραφία τη φορά — το pinakida.html
