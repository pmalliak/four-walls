...
const SCENARIOS = {
	...
	6786126: {
		what: "Πινακίδες από τον δρόμο που δεν έφτασαν στο info@ ή στο CRM",
		action: "Οι φωτογραφίες ζουν 30 ημέρες. Ειδοποίησε τον Πάνο, και πες στον σύμβουλο να μην τις σβήσει από το κινητό του μέχρι να λυθεί.",
	},
	6847367: {
		what: "Εισερχόμενη κλήση που δεν καταγράφηκε στην καρτέλα της επαφής",
		action: "Η κλήση φαίνεται κανονικά στο Zadarma. Αν ήταν σημαντική, γράψε την επικοινωνία με το χέρι στο CRM.",
	},
	6828361: {
		what: "Εξερχόμενη κλήση που δεν καταγράφηκε στην καρτέλα της επαφής",
		action: "Η κλήση φαίνεται κανονικά στο Zadarma. Αν ήταν σημαντική, γράψε την επικοινωνία με το χέρι στο CRM.",
	},
};
